...
export default function DetailsDashboard() {
  ...
  const navItems = [
    ...
    { id: 2, label: "Application Summary", icon: Home },
    { id: 3, label: "Visa Summary", icon: FilesIcon },
    { id: 4, label: "Payment", icon: MailOpen },
    { id: 5, label: "Notes", icon: FileText },
    { id: 6, label: "Documents", icon: Speaker },
  ];
      ...
      <div className="flex flex-col gap:6 md:flex-row md:items-center md:justify-between mb-4">
        <div>
          <h1 className="font-bold text-3xl mb-2">
            Student Details &ndash; {decodedSlug}
          </h1>
          <p className="mb-10 md:mb-0">
            Review all information for {decodedSlug}
          </p>
        </div>
        <div>
          <Link
