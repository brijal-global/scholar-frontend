...
const mockTickets: LanguageTicket[] = [
  {
    ...
    documentName: "D4",
    description:
      "D-4(General Trainee, Korean Language Program) visa is for those who go to education lower than University level or do research, study or train at an educational.",
  ...
  },
  {
    ...
    documentName: "D2",
    description:
      "Student visa (D-2) can be acquired at a Korean embassy or consulate in the applicant's home country",
    modifiedDate: "2025-09-08",
  },
  {
    id: "3",
              ...
              <tbody className="bg-white divide-y divide-[#EAECF0]">
                {mockTickets.map((ticket, index) => (
                  ...
                  >
                    ...
                    <td>
                      <div className="text-sm text-[#667085] w-3xl py-4">
                        {ticket.description}
                      </div>
                    </td>
                    <td>
