...
const mockTickets: EducationTicket[] = [
  {
    id: "1",
    documentName: "Certificate/Diploma",
    subCatagory: "Bachelor",
  ...
  {
    id: "4",
    documentName: "Professional Degree",
    subCatagory: "Bachelor",
    description: "Lorem Ipsum is simply dummy text of the.",
    modifiedDate: "2025-09-08",
  },
  ...
  return (
    <section>
      <div className="flex flex-col gap-4">
        {/* Header */}
        <div className="flex flex-col gap-4">
          <h2 className="font-bold text-gray-900">Educational Documents</h2>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 text-sm">
            ...
            <div className="flex items-center gap-4 max-md:flex-grow">
              ...
              <Link
                href="/Lorem Ipsum is simply dummy text of the./user-management/new"
            ...
            <table className="w-full">
              <thead className="border-b border-gray-200 text-sm font-medium text-gray-500 text-nowrap">
                <tr>
                  ...
                  <th className="text-left">Sub-Catagory</th>
