...
interface StudentPaymentTicket {
  id: string;
...
const mockTickets: StudentPaymentTicket[] = [
  {
    id: "1",
...
export default function StudentPayment() {
  ...
  function StylePallet({ status }: { status: StudentPaymentTicket["status"] }) {
    const Styles = {
