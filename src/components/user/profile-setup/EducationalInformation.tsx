        ...
        <form className="mt-4 text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-4">
            ...
            <div>
              ...
              <select
                id="midCountry"
                value={formData.midCountry}
                onChange={handleSelectChange}
                className={`w-full bg-white rounded-lg h-14 p-4 border border-gray-300  ${
                  formData.midCountry == "" ? "text-gray-300" : "text-gray-600"
                }`}
              >
                <option value="" disabled>
                  Select country
            ...
            <div>
              ...
              <select
                id="midGrade"
                value={formData.midGrade}
                onChange={handleSelectChange}
                className={`w-full bg-white rounded-lg h-14 p-4 border border-gray-300  ${
                  formData.midGrade == "" ? "text-gray-300" : "text-gray-600"
                }`}
              >
                <option value="" disabled>
                  Select grading scale
