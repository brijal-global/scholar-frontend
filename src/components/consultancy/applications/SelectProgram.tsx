...
const mockTickets: SelectProgram[] = [
  {
    id: "1",
            ...
            <table className="w-full text-sm">
              <thead className="border-b border-gray-200 text-sm font-medium text-gray-500 text-nowrap">
                <tr>
                  ...
                  <th className="text-left px-6 py-4 w-5xs">Program name</th>
                  <th className="text-left px-6 py-4">Program Type</th>
                  <th className="text-left px-6 py-4">Tuition fee/semester</th>
